...
<body>
  ...
  <hr>
    ...
    <label>Salary:</label>
		<input type="number" name="teacherSalary">
		<br>

    <label>DBS:</label>
		<input type="text" name="teacherDBS">
		<br>
  ...
  <?php
    ...
    $contact = $_POST['teacherContact'];
    $salary = $_POST['teacherSalary'];
    $dbs = $_POST['teacherDBS'];
		
		$sql = "INSERT INTO Teacher (TeacherID, TeacherName, TeacherAddress, TeacherContact, TeacherSalary, TeacherDBS) VALUES (NULL, '$name', '$address', '$contact', '$salary', '$dbs')";
